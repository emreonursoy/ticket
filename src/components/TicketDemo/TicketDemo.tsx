      ...
      <div className={styles.backTicketPass}>
        ...
        <div className={styles.partyRules}>
          <div className={styles.ruleItem}>
            ...
            <span className={styles.ruleText}>Love us because we love you - but also because we're awesome</span>
          </div>
          
          <div className={styles.ruleItem}>
            <span className={styles.ruleBullet}>•</span>
            <span className={styles.ruleText}>Drink responsibly, drive responsibly - we have great days ahead and we want you there!</span>
          </div>
          
          <div className={styles.ruleItem}>
            <span className={styles.ruleBullet}>•</span>
            <span className={styles.ruleText}>Dance like nobody's watching (even though everyone is watching)</span>
          </div>
